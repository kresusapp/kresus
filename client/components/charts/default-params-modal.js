                ...
                <div className="col-md-8 col-xs-12">
                    <select
                      ...
                      defaultValue={ this.displayType }>
                        ...
                        <option value='pos-neg'>{ $t('client.charts.differences_all') }</option>
                    </select>
                </div>
            </div>
...
const Export = connect(state => {
    ...
    return {
        showPositiveOps: amountType === 'all' || amountType === 'positive',
        showNegativeOps: amountType === 'all' || amountType === 'negative',
