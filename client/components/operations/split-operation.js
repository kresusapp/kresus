...
class SubOpEditForm extends React.Component {
    ...
    handleChangeAmount(event) {
        ...
        this.setState({ amount }, this.props.checkAmount);
    }
...
SubOpEditForm.propTypes = {
    ...
    checkAmount: React.PropTypes.func.isRequired,
        ...
        if (this.state.editMode) {
            subOps = (
                <SubOperationsEditMode
                  ...
                  categories={ this.props.categories }
                  getCategoryTitle={ this.props.getCategoryTitle }
                  handleSwitchToStaticMode={ this.handleToggleEdit }
                />
            );
        } else {
...
class SubOperationsEditMode extends React.Component {
    ...
    render() {
        ...
        subOps = this.props.subOperations.map((op, index) =>
            <SubOpEditForm ref={ `subOp${index}` } id={ op.id }
              ...
              title={ op.title }
              date={ op.date }
              checkAmount={ this.handleSumOfAmounts }
              getCategoryTitle={ this.props.getCategoryTitle }
              categories={ this.props.categories }
                ...
                <div className="form-group clearfix">
                    ...
                    <div className="col-xs-4 col-xs-offset-2">
                        <input className="form-control"
                          type="number" step="1" defaultValue="2"
                          min="2"
...
SubOperationsEditMode.propTypes = {
    ...
    categories: React.PropTypes.array.isRequired,
    getCategoryTitle: React.PropTypes.func.isRequired,
    handleSwitchToStaticMode: React.PropTypes.func.isRequired
};
