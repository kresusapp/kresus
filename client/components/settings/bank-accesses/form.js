...
class InitForm extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        if (this.defaultCategoriesCheckbox && this.defaultCategoriesCheckbox.checked) {
            let categories = DefaultCategories.map(category => Object.assign(
                category,
                {
