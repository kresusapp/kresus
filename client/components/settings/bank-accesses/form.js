...
class NewInitForm extends React.Component {
    ...
    render() {
        ...
        if (
            ...
            (this.state.defaultAlertsEnabled && !this.props.emailAddressSet && !this.state.emailRecipient)
        ) {
            ...
            maybeCategories = (
                <div className="row">
                    <div className="col-sm-12">
                        <input type="checkbox" id="default-categories" defaultChecked="{this.props.isOnboarding}" ref={refDefaultCategoriesCheckbox} /> <label htmlFor="default-categories">{$t('client.accountwizard.default_categories')}</label>
...
NewInitForm.propTypes /* remove-proptypes */ = {
    ...
    isOnboarding: PropTypes.bool.isRequired,  // TODO: Should default to false
