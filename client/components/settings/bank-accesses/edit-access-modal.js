...
class EditAccessModal extends React.Component {
    ...
    render() {
        ...
        // The warning to be displayed when the user clicks on the disable button.
        let disableButtonWarning = null;
        ...
        let buttonLabel;
        if (this.state.isActive) {
            buttonLabel = 'client.editaccessmodal.disable';
        } else if (this.props.access.isActive) {
            buttonLabel = 'client.editaccessmodal.cancel';
        } else {
            buttonLabel = 'client.editaccessmodal.enable';
        }
