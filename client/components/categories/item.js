...
class CategoryListItem extends React.Component {
    ...
    handleKeyUp(e) {
        ...
        } else if (e.key === 'Escape' && this.props.onCreationCancelled) {
            this.props.onCreationCancelled(e);
        }
        return true;
    }
    ...
    handleSave(e) {
        ...
        if (!title || !color) {
            if (this.isCreating() && this.props.onCreationCancelled) {
                this.props.onCreationCancelled(e);
            }
        ...
        if (this.isEditing()) {
            ...
            if (this.props.onCreationCancelled) {
                this.props.onCreationCancelled(e);
            }
        }
    ...
    handleDelete(e) {
        ...
        } else if (this.props.onCreationCancelled) {
            this.props.onCreationCancelled(e);
        }
    }
...
CategoryListItem.propTypes = {
    ...
    cancelCreation: React.PropTypes.func
};
