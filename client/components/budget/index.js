        ...
        return (
            <div className="budgets">
                ...
                <table className="table table-striped table-hover table-bordered budget">
                    <thead>
                        <tr>
                            <th className="budget-name">
                                {$t('client.category.column_category_name')}
                            </th>
                            <th className="budget-amount">{$t('client.budget.amount')}</th>
                            <th className="budget-threshold">{$t('client.budget.threshold')}</th>
                            <th className="budget-diff">{$t('client.budget.difference')}</th>
                            <th className="budget-button">&nbsp;</th>
                        </tr>
                    </thead>
                    <tbody>
                        {items}
                        <tr>
                            <th className="budget-name">{$t('client.budget.total')}</th>
                            <th className="budget-amount amount">{sumAmounts.toFixed(2)}</th>
                            <th className="budget-threshold amount">{sumThresholds.toFixed(2)}</th>
                            <th className="budget-diff amount">{remaining}</th>
                            <th className="budget-button">&nbsp;</th>
                        </tr>
                    </tbody>
                </table>
