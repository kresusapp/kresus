...
export default class CustomBankField extends React.Component {
    ...
    render() {
        ...
        switch (this.props.params.type) {
            ...
            case "password":
                customFieldFormInput = <input name={this.props.params.name}
                                        ...
                                        ref="field"
                                        placeholder={t(this.props.params.placeholderKey) || this.props.params.placeholder}
        ...
        return <div className="form-group">
            <label htmlFor={this.props.params.name}><T k={this.props.params.labelKey}>{this.props.params.label}</T></label>
