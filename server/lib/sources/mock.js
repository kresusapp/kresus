...
// Helpers.
export const rand = (low, high) => low + ((Math.random() * (high - low)) | 0);

export const randInt = (low, high) => rand(low, high) | 0;
...
export const generate = (access, generateDuplicates = false) => {
    let operations = [];
