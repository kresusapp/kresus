...
export const fetchAccounts = async function({ access }) {
    ...
    let values = [
        {
            ...
            iban: 'FR235711131719',
            currency: 'EUR',
            type: AccountTypes.find(type => type.name === 'type.checking').weboobvalue
        },
        {
            ...
            balance: '500',
            currency: 'USD',
            type: AccountTypes.find(type => type.name === 'type.savings').weboobvalue
        },
        {
            accountNumber: third,
    ...
    if (fourth) {
        values.push({
            ...
            title: 'Assurance vie',
            balance: '1000',
            type: AccountTypes.find(type => type.name === 'type.life_insurance').weboobvalue
        });
    }
