...
async function retrieveAllAccountsByAccess(userId, access) {
...
class AccountManager {
    ...
    async retrieveNewAccountsByAccess(userId, access, shouldAddNewAccounts) {
        ...
        for (let account of diff.providerOrphans) {
            ...
            let existingOperations = await Operation.byAccount(userId, account);
