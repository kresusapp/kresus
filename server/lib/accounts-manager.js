...
async function retrieveAllAccountsByAccess(access, updateFirst = false) {
...
class AccountManager {
    ...
    async retrieveNewAccountsByAccess(access, shouldAddNewAccounts, updateFirst = false) {
        ...
        let accounts = await retrieveAllAccountsByAccess(access, updateFirst);
