...
if __name__ == '__main__':
    ...
    if command == 'test':
        ...
        if not options.module:
            error(
                INVALID_PARAMETERS,
                'Module shall be set to a non empty string',
                None
            )
        ...
        if not options.login:
            error(
                INVALID_PARAMETERS,
                'Login shall be set to a non empty string',
                None
            )
        ...
        print('+%s+' % options.password, file=sys.stderr)
        ...
        if options.field is not None:
            for name, value in options.field:
                if not name:
                    error(
                        INVALID_PARAMETERS,
                        'Name of custom field shall be set to a non empty string',
                        None
                    )
                if not value:
                    error(
                        INVALID_PARAMETERS,
                        'Value of custom field shall be set to a non empty string',
                        None
                    )
                params[name] = value
