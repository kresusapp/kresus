module.exports = {
    ...
    client: {
        ...
        settings: {
            ...
            edit_credentials: 'Edit credential',
            disable_access: 'Disable access',
            enable_access: 'Enable access',
            disable: 'Disable',
            enable: 'Enable',
            cancel: 'Cancel',
            warn_before_disable_access: "On subitting these changes, this access will disabled. The password will be deleted. The related accounts, operations and alerts will be kept. The access will then be ignored during daily fetch.",
