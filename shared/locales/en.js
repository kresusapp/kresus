    ...
    client: {
        ...
        settings: {
            ...
            emails: {
                ...
                transaction_desc: 'The transaction alerts warn you when a new transaction is imported and its absolute value (ex: for a transaction of -20€, this will be "20") is lower or greater (your choice) than the absolute value of the threshold you defined.',
