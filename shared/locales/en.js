module.exports = {
    ...
    client: {
        ...
        disableaccessmodal: {
            ...
            body: "You are about to disable this access. By confirming this change, this access will be disabled, the daily fetch will not occur and the password will be deleted.",
            confirm: 'Confirm'
        },
        ...
        settings: {
            ...
            confirm_import: 'Are you sure you want to import this instance: %{filename}?',
            ...
            disable_access_button: 'Disable access',
            enable_access_button: 'Enable access',
            ...
            emails: {
                ...
                transaction_desc: 'The transaction alerts warn you when a new transaction is imported and its amount is lower or greater (your choice) than the amount of the threshold you defined.',
