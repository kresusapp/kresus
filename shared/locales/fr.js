    ...
    client: {
        ...
        settings: {
            ...
            emails: {
                ...
                balance_desc: 'Les alertes sur soldes vous préviennent lorsque le solde de votre compte bancaire devient inférieur ou supérieur (selon votre choix) au seuil que vous avez défini.',
                add_transaction: 'Ajouter une notification sur opération',
                transaction_desc: `Les alertes sur opérations vous préviennent lorsqu'une nouvelle opération est importée et que la valeur absolue (ex: pour une opération de -20€, ce sera donc "20") de cette dernière est inférieure ou supérieure (selon votre choix) au montant que vous avez défini.`,
