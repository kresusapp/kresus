module.exports = {
    ...
    client: {
        ...
        settings: {
            ...
            weboob_description: "Weboob est l'outil qu'utilise Kresus pour récupérer vos données bancaires. Ce module requiert parfois d'être mis à jour afin de suivre les évolutions des sites web des banques.",
