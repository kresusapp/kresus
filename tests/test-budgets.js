...
describe('budgets', function() {
    ...
    describe("when the threshold is above 0", () => {
        it('and amount below the threshold and below warning', () => {
        ...
        it('amount below the threshold and over warning', () => {
        ...
        it('and amount equal to the threshold', () => {
        ...
        it('and amount over the threshold', () => {
    ...
    describe("when the threshold is below 0", () => {
        ...
        it('and amount below the threshold and over warning', () => {
            const bars = getBars(-100, -80, WARNING_THRESHOLD_PERCENT);
