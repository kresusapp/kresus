...
describe('Defect situation', () => {
    // Todo : find a way to define a PATH to weboob to ensure it is not seen installed + fix it later.
 /*   describe('call test without weboob installed', ()=> {
...
*/
    describe('call an unknown command', () => {
        before(callWeboobBefore('unknown-command'));
...
describe('Normal uses', ()=> {
    ...
    describe('call operations', ()=> {
        ...
        it('all elements of the array shall be instances of Account', ()=> {
