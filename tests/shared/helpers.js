...
describe('shared helpers', () => {
    describe('localeContains', () => {
        ...
        it('should return true if the values are equal', () => {
            ...
            localeContains('Il était une fois', 'Il etait une fois', false).should.equal(true);
        });
        ...
        it('should return true if the first string contains the second', () => {
            ...
            localeContains('Un ensemble de mots', 'de mots', false).should.equal(true);
        ...
        it('should return false if the first string does not contain the second', () => {
            localeContains('Lorem ipsum', 'Doloret sit amet', false).should.equal(false);
            localeContains('Il était un petit navire', 'était une', false).should.equal(false);
        });
    });
});
