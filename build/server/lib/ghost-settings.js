...
const ConfigGhostSettings = new Set(['weboob-version', 'weboob-installed', 'standalone-mode', 'url-prefix', 'emails-enabled', 'can-encrypt', 'force-demo-mode' // 'theme' // It should be a ghost setting! But our migration order doesn't
// allow for this.
]);
