...
about: Vous avez rencontré un bug, et vous désirez le décrire (en français)
labels:
  - '🐛 bug'
---
...
- Mes logs côté client (s'ils s'appliquent) :

```
(compléter)
```

- Mes logs côté serveur (s'ils s'appliquent) :
